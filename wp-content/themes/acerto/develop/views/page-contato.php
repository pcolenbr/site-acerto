...
<section class="hero-section-com-bg position-relative" style="background-image: url('<?php echo $img_url?>');">
	<div class="container">
		<div class="absolute-align-center-left width-md-50 text-color-white">
			<h1 class="text-center text-md-left">Entre em contato com a Acerto</h1>
			<h5 class="text-center text-md-left">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed gravida, tellus sed hendrerit.</h5>
		</div>
	</div>
</section>

<section class="pb-0 px-3 px-md-0">
	<div class="contato-cta-ajuda-container background-cinza-claro width-md-50 text-center mx-auto py-5 px-5">
		<h5 class="mb-4">Precisando de ajuda? Já deu no nosso portal de ajuda?</h5>

		<a class="btn btn-lg btn-primary d-block midth-md-50 mx-auto" href="#">Procurar no portal de ajuda</a>
	</div>
</section>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-12 col-md-5 offset-md-1 contato-coluna-direita background-cinza-claro py-4 px-4 text-center text-md-left">
				<div class="mb-3">
					<h4 class="width-md-75 mb-4">É urgente? Liga pra gente!</h4>
				...
				<div class="mb-5">
					<h4 class="width-md-75 mb-4">As dúvidas mais comuns dos nossos usuários</h4>
